...
include_once dirname(__FILE__).'/elFinder.class.php';
include_once dirname(__FILE__).'/elFinderVolumeDriver.class.php';
include_once dirname(__FILE__).'/elFinderVolumeLocalFileSystem.class.php';
